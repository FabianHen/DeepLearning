...
Abschnitt~\ref{sec:methode} beschreibt die verwendete Datenbasis, die Vorverarbeitung sowie das Teacher-Student-Setup und das Distillationsverfahren.
...
Abschnitt~\ref{sec:fazit} fasst die Arbeit zusammen.
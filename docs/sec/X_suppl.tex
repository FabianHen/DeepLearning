...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/ValAccuracyAllNets.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/BestConfusion.png}
...
\begin{figure*}[!t]
    \centering
    \includegraphics[width=\textwidth]{figures/WorstConfusion.png}

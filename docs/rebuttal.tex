...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{Author Response}  % Update title as needed
...
Die in diesem Manuskript verwendeten Abbildungen sind in \texttt{docs/figures/} abgelegt und werden an den jeweiligen Stellen
mit \verb+\includegraphics+ eingebunden. Die Abbildungen sind als PNG/PDF
vorhanden und werden in der finalen PDF zusammen mit den zugehörigen
Beschriftungen und Legenden dargestellt.
